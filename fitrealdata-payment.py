...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 12:13:49 2022
...
path = r"/Users/nhungochoang/School/CS4830/Project2/data-set/payments" 
...
for file in dirList: 
    ...
    if name.find('payment') == 0 or name.find('ValidPayment') == 0: 
...
# check K-S goodness of fit for gamma distributed data 
...
cdf = stats.gamma.cdf(sortedData, fit_alpha, scale=fit_beta, loc=fit_loc) 
