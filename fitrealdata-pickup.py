...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 17:11:45 2022
...
path = r"/Users/nhungochoang/School/CS4830/Project2/data-set/pickups" 
...
for file in dirList: 
    ...
    if name.find('pickup') == 0 or name.find('ValidPayment') == 0: 
        if ext == 'xlsx': 
